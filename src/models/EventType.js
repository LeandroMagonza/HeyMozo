...
module.exports = (sequelize) => {
  const EventType = sequelize.define(
    "EventType",
    {
      ...
      branchId: {
        ...
        comment: "If set, this event type is specific to this branch",
      },
      eventName: {
    ...
    },
    {
      ...
      indexes: [
        ...
        {
          fields: ["companyId", "branchId", "isActive"],
        },
        {
      ...
      hooks: {
        ...
        beforeUpdate: (eventType, options) => {
          if (
            eventType.changed("systemEventType") &&
            eventType._previousDataValues.systemEventType
          ) {
  ...
  EventType.associate = (models) => {
    ...
    EventType.belongsTo(models.Branch, {
      foreignKey: "branchId",
      as: "branch",
    });
