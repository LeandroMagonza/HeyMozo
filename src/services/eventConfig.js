...
class EventConfigService {
  static async createDefaultEventTypes(companyId, createdBy = null) {
    ...
    const defaultEventTypes = [
      // Customer Actions (highest priority - require staff attention)
      {
        ...
        userIcon: "FaUserTie",
        adminColor: "#fd7e14",
        priority: 100, // Highest - manager called is most urgent
      ...
      },
      {
        ...
        userIcon: "FaUser",
        adminColor: "#ffc107",
        priority: 90, // High - customer needs attention
        systemEventType: null,
        isDefault: true,
      },
      {
        ...
        adminColor: "#17a2b8",
        priority: 80, // Medium-high - customer wants to pay
        systemEventType: null,
        isDefault: true,
      },
      // System Events (lower priority - status tracking)
      {
      ...
      },
      {
        ...
        userIcon: null,
        adminColor: "#d4edda",
        priority: 40, // Low - acknowledgment
      ...
      },
      {
        ...
        userIcon: null,
        adminColor: "#d1ecf1",
        priority: 10, // Lowest - table is free
