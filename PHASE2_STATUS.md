...
- **Verificado**: `npm run build` OK (sin warnings nuevos), smoke a nivel servicio 12/12 (goal/reward/branchName, `reachedGoal` por umbral, orden DESC, no filtra `branchId` interno, 404 branch inexistente).
