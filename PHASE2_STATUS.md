...
| 5.1 | `feature/sprint-5.1-customer-order-history` | — | — | feat(client): historial de pedidos de sesión activa — GET /api/tables/:id/orders (cookie device) + OrderHistoryModal en UserScreen. Prerequisito de Pagos digitales (Sprint 7). |
